# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2017-04-29 01:56
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='ModalCorrections',
            fields=[
                ('id_modal', models.IntegerField(primary_key=True, serialize=False)),
                ('reg_date', models.DateTimeField()),
            ],
            options={
        ...
        migrations.CreateModel(
            name='Modality',
            fields=[
                ('modal_id', models.SmallIntegerField(primary_key=True, serialize=False)),
                ('modality', models.CharField(blank=True, max_length=12, null=True)),
            ],
            options={
                'db_table': 'modality',
                'managed': False,
